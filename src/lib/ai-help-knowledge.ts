...
export const aiHelpTopics: AiHelpTopic[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "Public social-profile URLs entered in Setup are for profile links and manual sharing; they do not authorize automatic publishing. An account must appear as Connected in Scheduler before it can receive scheduled posts.",
