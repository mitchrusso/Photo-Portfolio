...
export const aiHelpTopics: AiHelpTopic[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "Every published subscriber website footer includes PhotoView.io Terms of Service and Privacy Policy links. Subscriber-selected bottom navigation links appear above those legal links.",
