...
export const aiHelpTopics: AiHelpTopic[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "Choose a homepage template from the horizontal template film strip at the top of the builder. The live page preview below updates when a different template is selected.",
      "Use the page controls in the builder to edit Home, About, Trips or Blog, What's in My Bag, Articles, Contact, and an optional custom page.",
      "For About, Trips or Blog, What's in My Bag, Articles, Contact, and custom page copy, choose the page in the builder and edit the fields that appear for that page.",
      "The builder includes color pickers for site background color and text color. Those choices are saved with the website draft.",
      ...
      "To set up the contact form destination, use the Contact page editor and enter the email address where contact messages should go.",
      "Use Save and preview website to save the draft and open the preview. The preview includes a Go back to builder button that returns to the My Website builder.",
