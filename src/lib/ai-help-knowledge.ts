...
export const aiHelpTopics: AiHelpTopic[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "Open the standalone Hero block and use Headline size to shrink or enlarge the overlay title from 40% to 140%. The Live Canvas, Preview, and published website use the same container-relative sizing rule, so the title keeps the same visual proportion.",
