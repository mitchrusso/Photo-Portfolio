...
export const aiHelpTopics: AiHelpTopic[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "PhotoView.io supplies the API URL automatically. Click Generate key on the Lightroom page to create the private 90-day PhotoView.io import key, then copy both values into Lightroom's PhotoView.io Export panel. The plugin labels the private import key as API Key; those names refer to the same value.",
