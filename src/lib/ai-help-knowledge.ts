...
export const aiHelpTopics: AiHelpTopic[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "Choose the overall template from the filmstrip, then open Template controls to choose Adaptive Width or Full Screen and set the site background color or upload your own background image, text color, accent color, font style, image frame, line thickness, and image shape. The color remains the fallback when no background image is used.",
