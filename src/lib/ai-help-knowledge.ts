...
export const aiHelpTopics: AiHelpTopic[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "The builder keeps page sections, content, and design controls together on the left while the Live Canvas stays visible beside them.",
      ...
      "Quick add gear asks first whether the subscriber has an affiliate account, then which retailer it belongs to. Paste Amazon, B&H Photo, Adorama, or another retailer's product links to scan their public product details, review and delete rows, then use Add and save draft to store the imported list.",
