...
export const aiHelpTopics: AiHelpTopic[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "Open Template controls to adjust colors, upload or replace a custom website background image, choose the font style, and set the image frame, line thickness, and image shape. The controls have their own vertical scroll area, and the Live Canvas updates as settings change.",
