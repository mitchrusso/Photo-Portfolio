...
export const aiHelpTopics: AiHelpTopic[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "For an existing account, choose Organize unfiled portfolios to create a named parent gallery and group the currently unfiled portfolios inside it. This changes only their organization; no portfolio or photo is renamed, duplicated, deleted, or physically transferred.",
      ...
      "Use the pencil beside an existing gallery name to rename that gallery. Every portfolio assigned to it stays inside the renamed gallery.",
      "Use the trash icon beside a gallery to delete it only after it is empty. PhotoView.io refuses to delete a gallery that still contains portfolios, so portfolios and photos cannot be removed accidentally.",
