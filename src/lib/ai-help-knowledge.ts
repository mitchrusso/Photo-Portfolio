...
export const aiHelpTopics: AiHelpTopic[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "Every published subscriber website footer identifies the PhotoView.io Terms and PhotoView.io Privacy links as platform policies. It also explains that the subscriber is solely responsible for their website content and that PhotoView.io provides the publishing platform. Subscriber-selected bottom navigation links appear above that notice.",
