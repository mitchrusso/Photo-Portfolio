...
export const aiHelpTopics: AiHelpTopic[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "Public account URLs support manual sharing. Automatic publishing requires OAuth permission from each social platform; PhotoView.io never asks for or stores social-media passwords.",
    ],
  ...
  },
  {
    ...
    details: [
      ...
      "Turn on Edit hints in the website-builder toolbar, then point to a headline, paragraph, image, gallery, or page section. The contextual hint explains what controls it and Show me opens the correct page in the left menu, scrolls to the setting, focuses it, and highlights the exact control.",
  ...
  {
    title: "Imports",
    summary: "PhotoView.io supports direct uploads plus importer workflows from common photography tools.",
    details: [
      "SmugMug import can discover and bring over galleries when credentials and source URLs are configured.",
      "The Lightroom Classic plugin can publish selected exported images into PhotoView.io portfolios.",
