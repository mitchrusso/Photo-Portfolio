...
export const aiHelpTopics: AiHelpTopic[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "Featured Work and All Portfolios each have their own Display as control. Either section can independently use a slideshow, thumbnail grid, film strip, or cover cards, and the Live Canvas updates as soon as you choose one.",
