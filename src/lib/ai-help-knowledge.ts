...
export const aiHelpTopics: AiHelpTopic[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "Give each embed a clear name, such as Homepage, Client work, or About page. Every tab remembers its own selection and generated code after Settings is saved.",
      ...
      "Copy the iframe code from each tab and paste it into the matching location on the outside website. Different tabs can be placed on different pages of the same website.",
  ...
  },
  {
    ...
    details: [
      ...
      "On the Smart Folders page, configure a local watch folder and run the supplied watcher on the computer where your editing app exports files. It can send new files from Capture One, Photoshop, Affinity, DxO, ON1, Luminar, Photo Mechanic, darktable, RawTherapee, and similar tools.",
    ...
    keywords: ["import", "endpoint", "api url", "api key", "smugmug", "oauth", "connect smugmug", "lightroom", "plugin", "existing portfolio", "new portfolio", "smart folder", "phone import", "photo upload", "folder", "library", "bulk"],
  },
  {
