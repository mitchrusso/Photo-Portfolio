...
const walkthroughs: Record<WebsiteWalkthroughGoal, WebsiteWalkthrough> = {
  ...
  "first-site": {
    ...
    steps: [
      { id: "first-template", title: "Choose the visitor experience", description: "Start with any template. Editorial Story, Cinematic Chapters, and Museum Index add project-to-project navigation, a full story index, and single-image or grid viewing while keeping the same portfolio content.", destination: { kind: "tool", tool: "style" } },
