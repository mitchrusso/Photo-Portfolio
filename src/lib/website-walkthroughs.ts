...
const walkthroughs: Record<WebsiteWalkthroughGoal, WebsiteWalkthrough> = {
  ...
  "whats-new": {
    ...
    steps: [
      ...
      { id: "new-builder-controls", title: "Customize the complete website canvas", description: "Use Adaptive Width or Full Screen, save and reuse up to 12 background images, switch to a solid color without deleting them, adjust Screen back and Brightness, choose full-frame grids, and add movable Home Text blocks, Portfolio grids, or up to five custom pages.", destination: { kind: "panel", panel: "website" } },
