...
const walkthroughs: Record<WebsiteWalkthroughGoal, WebsiteWalkthrough> = {
  ...
  "custom-domain": {
    ...
    steps: [
      ...
      { id: "domain-enter", title: "Enter the visitor address", description: "Under Purchased custom domain, enter the preferred address visitors should see, such as example.com or www.example.com. Do not include https://, a slash, or a page path, then select Connect domain. PhotoView also connects the matching root or www address and redirects it here.", destination: { kind: "address" } },
  ...
  "start-here": {
    ...
    steps: [
      ...
      { id: "start-imports", title: "Choose how to bring in photographs", description: "Open Imports and use the five-option bar across the top. Choose Lightroom, Phone, Smart Folders, SmugMug Import, or Photo Upload; each option opens its own setup and beginner guide.", destination: { kind: "settings", tab: "imports" } },
      ...
      { id: "start-website", title: "Build the public website", description: "Open My Website to choose a template, select Adaptive Width or Full Screen, and create the home, About, Trips, Articles, Contact, equipment, and up to five custom pages. Preview before anything goes live.", destination: { kind: "panel", panel: "website" } },
      ...
      { id: "start-gallery", title: "Protect Galleries and Portfolios", description: "Open Portfolio settings to add an optional Gallery-wide password, an independent Portfolio password, and email two-factor verification for either level. Then review downloads, labels, covers, and watermarks.", destination: { kind: "settings", tab: "gallery" } },
  ...
  "whats-new": {
    ...
    steps: [
      ...
      { id: "new-background-library", title: "Save and switch among multiple backgrounds", description: "Open Template controls to save up to 12 website background images. Select any saved thumbnail to reuse it, choose Solid without deleting the collection, and adjust Screen back or Brightness for the active image.", destination: { kind: "tool", tool: "style" } },
      { id: "new-builder-controls", title: "Customize the complete website canvas", description: "Use Adaptive Width or Full Screen, choose full-frame grids, and add movable Home Text blocks, Portfolio grids, or up to five custom pages.", destination: { kind: "panel", panel: "website" } },
  ...
  "first-site": {
    ...
    steps: [
      { id: "first-template", title: "Choose the visitor experience", description: "Start with any template. For a distinctive portfolio, try Kinetic Headline, Atelier Split, Triptych Stage, Commercial Casebook, Studio Split, Swiss Sequence, Object Stage, Specimen Wall, Quiet Sequence, or Acclaim Portfolio. Every choice uses the same PhotoView portfolios, so you can change the experience without rebuilding the content.", destination: { kind: "tool", tool: "style" } },
      ...
      { id: "first-backgrounds", title: "Build a reusable background collection", description: "Upload one or more website backgrounds in Template controls. PhotoView saves up to 12, lets you switch among them, and keeps them available when you temporarily choose a solid color.", destination: { kind: "tool", tool: "style" } },
  ...
  "settings-overview": {
    ...
    steps: [
      ...
      { id: "settings-gallery", title: "Control Gallery and Portfolio access", description: "Protect the containing Gallery, the selected Portfolio, or both with passwords and optional emailed verification codes, then set downloads, covers, labels, and watermarks.", destination: { kind: "settings", tab: "gallery" } },
      { id: "settings-imports", title: "Choose an import system", description: "Use the five-option bar across the top of Imports to open Lightroom, Phone, Smart Folders, SmugMug Import, or Photo Upload. Each page explains setup, destination choices, and what happens after the photographs arrive.", destination: { kind: "settings", tab: "imports" } },
