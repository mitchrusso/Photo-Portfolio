...
export const settingsTabs: Array<{ id: SettingsTab; label: string; description: string; help: string; helpQuestion: string }> = [
  ...
  { id: "imports", label: "Imports", description: "Lightroom, SmugMug, desktop, phone, and direct uploads", help: "Bring photographs into PhotoView.io from Lightroom Classic or another supported source. Lightroom can create a new portfolio or add selected photos to an existing one.", helpQuestion: "How do I install the Lightroom plugin and send selected photos to a portfolio?" },
