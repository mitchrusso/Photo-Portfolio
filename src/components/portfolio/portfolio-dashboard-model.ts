...
export const settingsTabs: Array<{ id: SettingsTab; label: string; description: string; help: string; helpQuestion: string }> = [
  { id: "setup", label: "Setup", description: "Photographer profile and social accounts", help: "Add your identity, contact details, and public social profiles. Saved accounts become available throughout PhotoView.io sharing tools.", helpQuestion: "How do I complete Setup and connect my social profile links?" },
  ...
  { id: "gallery", label: "Gallery", description: "Access, covers, downloads, and watermarking", help: "Control public access, privacy, downloads, cover behavior, photo labels, and text or custom-image watermarks for the active portfolio.", helpQuestion: "How do I control gallery access, downloads, covers, and watermarks?" },
  { id: "imports", label: "Imports", description: "SmugMug, Lightroom, desktop, and direct uploads", help: "Bring photographs into PhotoView.io from supported services, a watched computer folder, a phone, or a direct file upload.", helpQuestion: "Which import method should I use, and how do I set it up?" },
