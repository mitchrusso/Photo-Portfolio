...
export const settingsTabs: Array<{ id: SettingsTab; label: string; description: string; help: string; helpQuestion: string }> = [
  ...
  { id: "sharing", label: "Sharing", description: "Links, embeds, social previews, and QR codes", help: "Use PhotoView.io as the central image dashboard for consumer, business, partner, and Shopify sites. Reuse one live iframe across sites that should match, or save separate embed profiles for placements that need different selections.", helpQuestion: "How do I manage several live embeds across external and Shopify websites?" },
  ...
  { id: "imports", label: "Imports", description: "Lightroom, Phone, Smart Folders, SmugMug, and direct photo/video upload", help: "Choose one focused import page across the top. Smart Folders can create up to 12 publishing lanes from finished desktop exports to separate portfolios, which can power one or many live website embeds.", helpQuestion: "How do I import finished images and route Smart Folders to live website embeds?" },
