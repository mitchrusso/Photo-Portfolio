...
export const settingsTabs: Array<{ id: SettingsTab; label: string; description: string; help: string; helpQuestion: string }> = [
  ...
  { id: "sharing", label: "Sharing", description: "Links, embeds, social previews, and QR codes", help: "Choose exactly what to share, then copy a link, send an invitation, create and save multiple external-website embeds, open a social destination, or generate a QR code.", helpQuestion: "How do I share a portfolio, use a QR code, or embed galleries on an external website?" },
  ...
  { id: "imports", label: "Imports", description: "Lightroom, Phone, Smart Folders, SmugMug, and direct photo/video upload", help: "Choose one focused import page across the top. Each system includes its setup, destination controls, and step-by-step help.", helpQuestion: "Which import method should I use, and how do I set it up?" },
