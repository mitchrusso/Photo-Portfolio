...
test("dashboard uses persistent Gallery to Portfolio to Photo organization and explains portfolio autosave", () => {
  ...
  assert.match(dashboardSource, /Organize unfiled portfolios/)
  assert.match(dashboardSource, /Group all \{unfiledPortfolioCount\} unfiled portfolio/)
  assert.match(dashboardSource, /It does not rename, duplicate, delete, or physically transfer any portfolio or photo/)
  assert.match(dashboardSource, /Rename .* gallery/)
  assert.match(dashboardSource, /id="rename-gallery-title">Rename gallery/)
  assert.match(dashboardSource, /Change the gallery name without moving, renaming, duplicating, or deleting any portfolio or photo inside it/)
