...
async function main() {
  ...
  try {
    ...
    const registration = await persistTrialRegistration({
      ...
      subscriberLicenseAcceptedAt: now,
      subscriberLicenseSignerName: "Lifecycle Owner",
      subscriberLicenseVersion: "lifecycle-test",
      termsAcceptedAt: now,
    ...
    const neighbor = await persistTrialRegistration({
      ...
      subscriberLicenseAcceptedAt: now,
      subscriberLicenseSignerName: "Lifecycle Neighbor",
      subscriberLicenseVersion: "lifecycle-test",
      termsAcceptedAt: now,
      termsVersion: "lifecycle-test",
